...
export default function PerfKoDashboard() {
  ...
  return (
    <Admin>
      ...
      <div className="mt-3 grid grid-cols-2 gap-5 lg:grid-cols-3 3xl:grid-cols-6">
        {firstTitle ? 
        <Widget
      ...
      <div className="mt-5 h-[610px] md:h-[305px] grid gap-5 grid-cols-1 md:grid-cols-2">
      ...
      <div className="mt-5 h-[915px] md:h-[305px] grid gap-5 grid-cols-1 md:grid-cols-2">
      {firstAnalysisTitle ?
